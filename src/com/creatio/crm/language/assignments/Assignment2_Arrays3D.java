...
public class Assignment2_Arrays3D {
	...
	public static void main(String[] args) {
        ...
        // Defining a 3D array to store products
        String[][][] products = new String[2][4][5];

        // Main Category 1: Groceries
        
        // Sub category 1: Beverages
        products[0][0][0] = "Cola";
